...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('requires_public_road_frontage', sa.Boolean, nullable=False,
                  server_default='true'),
    ...
    op.create_table(
        ...
        sa.Column('zoning_district_id', postgresql.UUID(as_uuid=True),
    ...
    op.create_table(
        ...
        sa.Column('parcel_id', postgresql.UUID(as_uuid=True),
                  sa.ForeignKey('parcels.id'), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column('requires_flag_lot_provision', sa.Boolean, nullable=False,
    ...
    op.create_table(
        ...
        sa.Column('primary_scenario_id', postgresql.UUID(as_uuid=True),
...
def downgrade() -> None:
    ...
    for enum_name in [
        'recommendation_enum', 'report_status_enum', 'subdivision_review_tier_enum',
        'lot_layout_type_enum', 'constraint_severity_enum', 'constraint_type_enum',
